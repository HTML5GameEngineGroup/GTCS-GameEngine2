...
RigidCircle.prototype.collideCircCirc = function (c1, c2, collisionInfo) {
    let vFrom1to2 = [0, 0];
    // Case A: Determine if the circles overlap
    ...
    if (dist !== 0) {
        // Case B: Colliding circle centers are at different positions
        ...
        let n = [0, -1];
        // Case C: Colliding circle centers are at exactly the same position
