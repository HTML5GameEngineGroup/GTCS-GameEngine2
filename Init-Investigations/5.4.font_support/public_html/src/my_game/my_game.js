...
class MyGame extends engine.Scene {
    ...
    draw() {
        ...
        engine.clearCanvas([1.9, 0.9, 0.9, 1.0]); // clear to light gray
    ...
    update() {
        ...
        //      mTexLeft,   mTexBottom
        var b = texCoord[engine.eTexCoordArray.eBottom] + deltaT;
        var r = texCoord[engine.eTexCoordArray.eRight] - deltaT;
        if (b > 1.0) {
            b = 0;
        }
        if (r < 0) {
        ...
        this.mFontImage.setElementUVCoordinate(
            texCoord[engine.eTexCoordArray.eLeft],
            r,
            b,
            texCoord[engine.eTexCoordArray.eTop]
        );
        // </editor-fold>
