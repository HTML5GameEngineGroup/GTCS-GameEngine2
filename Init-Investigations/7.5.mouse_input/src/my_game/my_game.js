...
class MyGame extends engine.Scene {
    ...
    update() {
        ...
        if (engine.input.isButtonPressed(engine.input.mouseButton.Middle)) {
        ...
        if (engine.input.isButtonClicked(engine.input.mouseButton.Right)) {
            this.mPortal.setVisibility(false);
        }

        if (engine.input.isButtonClicked(engine.input.mouseButton.Middle)) {
