...
class SimpleShader {
    ...
    constructor(vertexShaderPath, fragmentShaderPath) {
        ...
        this.#mVertexShader = this.#loadAndCompileShader(vertexShaderPath, gl.VERTEX_SHADER);
        this.#mFragmentShader = this.#loadAndCompileShader(fragmentShaderPath, gl.FRAGMENT_SHADER);
