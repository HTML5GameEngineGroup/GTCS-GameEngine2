...
class SimpleShader {
    ...
    constructor(vertexShaderID, fragmentShaderID) {
        ...
        this.#mVertexShader = this.#loadAndCompileShader(vertexShaderID, gl.VERTEX_SHADER);
        this.#mFragmentShader = this.#loadAndCompileShader(fragmentShaderID, gl.FRAGMENT_SHADER);
    ...
    // The #-size says this is a private method
