...
class Brain extends engine.GameObject {
    constructor(spriteTexture) {
        ...
        this._mRenderComponent.getXform().setPosition(50, 10);
        this._mRenderComponent.getXform().setSize(3, 5.4);
        this._mRenderComponent.setElementPixelPositions(600, 700, 0, 180);
