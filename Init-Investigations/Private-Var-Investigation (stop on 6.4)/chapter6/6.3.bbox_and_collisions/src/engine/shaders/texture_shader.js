...
class TextureShader extends SimpleShader {
    ...
    constructor(vertexShaderPath, fragmentShaderPath) {
        ...
        let gl = glSys.get();
        this.#mTextureCoordinateRef = gl.getAttribLocation(this._mCompiledShader, "aTextureCoordinate");
        this.#mSamplerRef =  gl.getUniformLocation(this._mCompiledShader, "uSampler");
    }
