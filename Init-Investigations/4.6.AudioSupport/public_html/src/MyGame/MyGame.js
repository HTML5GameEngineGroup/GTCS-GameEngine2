...
class MyGame extends engine.Scene {
    ...
    init() {
        ...
        this.mSupport = new engine.Renderable(engine.defaultResources.mConstColorShader);
        ...
        this.mHero = new engine.Renderable(engine.defaultResources.mConstColorShader);
